...
<head>
    ...
    <style>
        ...
        .header { background: #198754; color: #fff; padding: 25px; text-align: center; border-radius: 4px 4px 0 0; }
        .content { padding: 30px; border: 1px solid #ddd; background: #fff; }
        .badge { display: inline-block; background: #d1e7dd; color: #0f5132; padding: 6px 14px; border-radius: 20px; font-weight: bold; }
        ...
        .note-box { background: #f8f9fa; border-left: 4px solid #198754; padding: 12px 16px; margin: 15px 0; border-radius: 0 4px 4px 0; }
        .btn { display: inline-block; background: #198754; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 4px; margin-top: 15px; }
...
<div class="container">
    ...
    <div class="content">
        <p>Hello,</p>
        <p>Great news — a patient has <span class="badge">accepted</span> quotation <strong>{{ $quotation->reference_number }}</strong>.</p>
        ...
        <table class="detail-table">
            ...
            <tr>
                <td>Total Cost</td>
                <td><strong>{{ $quotation->currency }} {{ number_format($quotation->total_cost) }}</strong></td>
            </tr>
            <tr>
                <td>Responded At</td>
        ...
        <div class="note-box">
            <strong>Patient note:</strong><br>
            {{ $quotation->patient_response_note }}
        </div>
        @endif

        <p>Please log in to the admin panel to take the next steps and arrange the patient's treatment.</p>
