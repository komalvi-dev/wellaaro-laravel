...
@section('breadcrumb')
<nav aria-label="breadcrumb"><ol class="breadcrumb mb-0"><li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li><li class="breadcrumb-item"><a href="{{ route('admin.hospitals.index') }}">Hospitals</a></li><li class="breadcrumb-item active">Add Hospital</li></ol></nav>
@endsection
@section('content')
...
<form action="{{ route('admin.hospitals.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-footer bg-white d-flex gap-2">
            <button type="submit" class="btn btn-primary"><i class="fas fa-save me-1"></i>Save Hospital</button>
