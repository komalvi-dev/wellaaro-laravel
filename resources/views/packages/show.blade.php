...
<div class="bg-light py-4 mb-4">
    <div class="container">
        <nav aria-label="breadcrumb"><ol class="breadcrumb small mb-2"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item"><a href="{{ route('packages.index') }}">Packages</a></li><li class="breadcrumb-item active">{{ $package->name }}</li></ol></nav>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white fw-semibold">Package Highlights</div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white fw-semibold">Inclusions</div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white fw-semibold">Exclusions</div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm sticky-top" style="top:80px;">
                <div class="card-body">
                    @if($package->price_usd_from)<div class="h4 text-success fw-bold mb-1">From ${{ number_format($package->price_usd_from) }}</div>@endif
                    @if($package->price_note)<p class="text-muted small mb-3">{{ $package->price_note }}</p>@endif
                    <div class="mb-3">
                        @if($package->duration_days_min)<p class="mb-1 small"><i class="fas fa-clock me-2 text-muted"></i>{{ $package->duration_days_min }}-{{ $package->duration_days_max ?? $package->duration_days_min }} days</p>@endif
                    ...
                    <a href="{{ route('get_quote') }}?package_id={{ $package->id }}" class="btn btn-primary w-100">Book This Package</a>
                </div>
            </div>
        </div>
    </div>
