...
<head>
    ...
    <style>
        ...
        .btn-warning { transition: background-color 0.15s ease, border-color 0.15s ease, color 0.15s ease; }
        .btn-warning:hover { background-color: #1a6bcc !important; border-color: #1a6bcc !important; color: #fff !important; }
        ...
        #header-nav .nav-link { font-size: 0.875rem; font-weight: 500; color: rgba(255,255,255,0.88); padding: 0.7rem 0.75rem; border-bottom: 2px solid transparent; border-radius: 0; transition: color 0.15s, background-color 0.15s, border-color 0.15s; white-space: nowrap; }
        #header-nav .nav-link.active { color: #fff; border-bottom-color: rgba(255,255,255,0.7); }
        #header-nav .nav-link:hover { color: #1e293b; background-color: #fff; border-bottom-color: #fff; }
        ...
        .card-hover { transition: background-color 0.2s ease, box-shadow 0.2s ease, transform 0.2s ease; }
        .card-hover:hover { background-color: #eaf2fd; box-shadow: 0 10px 28px rgba(0,0,0,0.12) !important; transform: translateY(-3px); }
        footer a { transition: color 0.15s ease; }
        footer a:hover { color: #4dabf7 !important; text-decoration: underline; }
    </style>
    @stack('styles')
    @php
...
<body>
    ...
    @include('shared.whatsapp-widget')
