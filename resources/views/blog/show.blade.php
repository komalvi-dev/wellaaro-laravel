...
<div class="container py-5">
    <div class="row g-4">
        <div class="col-lg-8">
            <nav aria-label="breadcrumb"><ol class="breadcrumb small mb-3"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item"><a href="{{ route('blog.index') }}">Blog</a></li><li class="breadcrumb-item active">{{ Str::limit($post->title, 40) }}</li></ol></nav>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body text-center">
                    <h6 class="fw-bold">Ready for Your Treatment?</h6>
                    <p class="text-muted small">Get a free consultation from our medical coordinators</p>
                    <a href="{{ route('get_quote') }}" class="btn btn-primary w-100">Get Free Quote</a>
                </div>
            </div>
            @if(isset($relatedPosts) && $relatedPosts->count())
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white fw-semibold">Related Posts</div>
