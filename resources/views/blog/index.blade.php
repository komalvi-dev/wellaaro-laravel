...
<div class="bg-light py-4 mb-4">
    <div class="container">
        <h1 class="h3 fw-bold mb-1">Health & Travel Blog</h1>
        <nav aria-label="breadcrumb"><ol class="breadcrumb small mb-0"><li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li><li class="breadcrumb-item active">Blog</li></ol></nav>
    </div>
</div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="row g-4">
                        ...
                        <div class="card card-hover h-100 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2">
                                    ...
                                    @if($post->read_time_minutes)<small class="text-muted">{{ $post->read_time_minutes }} min read</small>@endif
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                @empty
                <div class="col-12 text-center py-5 text-muted">No posts yet.</div>
                @endforelse
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center">
                    <h6 class="fw-bold">Get Free Medical Quote</h6>
                    <p class="text-muted small">Consult our medical experts today</p>
                    <a href="{{ route('get_quote') }}" class="btn btn-primary btn-sm w-100">Get Quote</a>
                </div>
            </div>
        </div>
    </div>
