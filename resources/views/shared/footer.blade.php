    ...
    <div class="container">
        <div class="row g-4 pb-4 border-bottom border-secondary">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="text-white small">{{ __('Connecting patients worldwide with world-class healthcare at affordable costs. Your trusted medical tourism partner.') }}</p>
            ...
            <div class="col-lg-3 col-md-6">
                <h6 class="fw-semibold text-white mb-3">{{ __('Patient Support') }}</h6>
                <ul class="list-unstyled small">
                    <li class="mb-1"><a href="{{ route('travel_guide') }}" class="text-white text-decoration-none">{{ __('Travel Guide') }}</a></li>
                    <li class="mb-1"><a href="{{ route('faq') }}" class="text-white text-decoration-none">{{ __('FAQ') }}</a></li>
                    <li class="mb-1"><a href="{{ route('patient_stories') }}" class="text-white text-decoration-none">{{ __('Patient Testimonials') }}</a></li>
                </ul>
            </div>

            <div class="col-lg-3 col-md-6">
                <h6 class="fw-semibold text-white mb-3">{{ __('Company / Discover') }}</h6>
                <ul class="list-unstyled small">
                    <li class="mb-1"><a href="{{ route('services') }}" class="text-white text-decoration-none">{{ __('Our Services') }}</a></li>
                    <li class="mb-1"><a href="{{ route('how_it_works') }}" class="text-white text-decoration-none">{{ __('How It Works') }}</a></li>
                    <li class="mb-1"><a href="{{ route('accreditations') }}" class="text-white text-decoration-none">{{ __('Accreditations') }}</a></li>
                </ul>
            </div>
            ...
            <div class="col-12">
                <p class="small text-secondary">{{ __('Note: Wellaaro Health does not provide medical advice, diagnosis or treatment. The services and information offered on www.Wellaaro.com are intended solely for informational purposes and cannot replace the professional consultation or treatment by a physician. Wellaaro Health discourages copying, cloning of its webpages and its content and it will follow the legal procedures to protect its intellectual property.') }}</p>
            </div>
        </div>

        <div class="row mt-3 align-items-center">
            <div class="col-md-6 small text-white">
                &copy; {{ date('Y') }} Wellaaro. {{ __('All rights reserved.') }}
            </div>
            <div class="col-md-6 text-md-end small">
                <a href="{{ route('privacy_policy') }}" class="text-white me-3">{{ __('Privacy Policy') }}</a>
                <a href="{{ route('terms') }}" class="text-white me-3">{{ __('Terms of Service') }}</a>
            </div>
        </div>
    </div>
</footer>
