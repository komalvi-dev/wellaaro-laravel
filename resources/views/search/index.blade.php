...
<div class="bg-light py-4 mb-4">
    <div class="container">
        <h1 class="h3 fw-bold mb-2">Search Results</h1>
        <form action="{{ route('search') }}" method="GET" class="d-flex gap-2" style="max-width:500px;">
            <input type="text" name="q" class="form-control" value="{{ request('q') }}" placeholder="Search hospitals, doctors, treatments...">
...
<div class="container py-4">
    ...
    @else
    <p class="text-muted mb-4">Results for: <strong>{{ request('q') }}</strong></p>
    @if(isset($hospitals) && $hospitals->count())
    <h5 class="fw-bold mb-3">Hospitals</h5>
    ...
    <h5 class="fw-bold mb-3">Doctors</h5>
    <div class="row g-3 mb-4">
    ...
    <h5 class="fw-bold mb-3">Treatments</h5>
    <div class="row g-3 mb-4">
    ...
    <div class="text-center py-5 text-muted">
        ...
        <a href="{{ route('get_quote') }}" class="btn btn-primary">Ask Our Experts</a>
    </div>
    @endif
    @endif
</div>
